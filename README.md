...
**Description**: I want ot build a data workflow management tool. Part of it involves visualising the deoendencies between tasks in DAG, please make a quick example of a view where tasks and their dependncies are a visualied in a directed acyclic graph. 
...
```sh
git clone https://github.com/GPT-Engineer-App/flowvizor.git
cd flowvizor
npm i
